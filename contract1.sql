...
--
CREATE TABLE `contractdetail_aadhaar` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `aadhaarid` longtext NOT NULL, `created` datetime(6) NOT NULL, `createdby` varchar(20) NOT NULL, `updated` datetime(6) NOT NULL, `updatedby` varchar(20) NOT NULL, `contractdetailid_fk_id` integer NOT NULL);
--
...
ALTER TABLE `contractdetail_aadhaar` ADD CONSTRAINT `contractdetail_aadha_contractdetailid_fk__88b24732_fk_contract_` FOREIGN KEY (`contractdetailid_fk_id`) REFERENCES `contract_contractdetail` (`contractdetid`);
